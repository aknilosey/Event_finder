...
class User {
	...
	public function getFirstAndLastName() {
		$username = $this->user['username'];
		$query = mysqli_query($this->con, "SELECT firstname, lastname FROM User WHERE username='$username'");
		$row = mysqli_fetch_array($query);
	...
	public function getProfilePic() {
		$username = $this->user['username'];
		$query = mysqli_query($this->con, "SELECT profilepic FROM User WHERE username='$username'");
		$row = mysqli_fetch_array($query);
