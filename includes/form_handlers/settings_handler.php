...
if(isset($_POST['update_details'])) {
	...
	$email_check = mysqli_query($con, "SELECT * FROM User WHERE emailid='$email'");
	...
	if($matched_user == "" || $matched_user == $userLoggedIn) {
		...
		$query = mysqli_query($con, "UPDATE User SET firstname='$first_name', lastname='$last_name', emailid='$email' WHERE username='$userLoggedIn'");
	}
	else 
